...
function drawBarChart(rawdata,pos,useColumnChart,options) {
	// var rawdata=[
	// ['', 'Sales', 'Expenses'],
	// ['2004', 1000, 400],
	// ['2005', 1170, 460],
...
//							alert(json.err);
						...
						else if (senario_name=="User location")
						{
							...
							$("#topic_name").html("User locations of the last 400 tweeters");
							init_map(loci);
						}
						else {
...
//								}
							...
							drawBarChart(rawdata,'main_chart',1,{colors : get_colors(2)});
